...
import com.huawei.devbridge.relaycontroller.interfaces.api.MeteringApi;
...
public class MeteringController implements MeteringApi {
    ...
    @Override
    public Result<MeteringReportResponse> report(String gridName, MeteringReportRequest request) {
